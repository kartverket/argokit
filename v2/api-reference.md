...
Oppretter en miljøvariabel for en app
...
Oppretter flere miljøvariabler for en app
...
Oppretter en miljøvariabel fra en secret

|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|name|`string`|`true`| - |navn på miljøvariabelen|
|secretRef|`string`|`true`| - |navn på secret|
|key|`string`|`false`|name|nøkkel i secret (default er samme som name)|

**eksempel:** [examples/environment.jsonnet](https://github.com/kartverket/argokit/blob/main/v2/examples/environment.jsonnet)

### `argokit.appAndObjects.application.withEnvironmentVariablesFromSecret()`
Oppretter miljøvariabler fra en secret

|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|secretName|`string`|`true`| - |navn på secret|
...
|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|host|`string`|`true`| - |hostname til Postgres-instansen|
...
|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|host|`string`|`true`| - |hostname til Oracle-databasen|
...
|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|host|`string`|`true`| - |hostname til SSH-serveren|
...
|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|host|`string`|`true`| - |hostname til LDAP-serveren|
...
|navn|type|obligatorisk|standardverdi|beskrivelse|
|-|-|-|-|-|
|host|`string`|`true`| - |hostname til serveren|
...
|hostname|`string`|`true`| - |hostname for ruten|
|redirectToHTTPS|`boolean`|`false`|true|om trafikk skal redirectes til HTTPS|
...
Legg til en namespace‑admin‑gruppe som subject
...
|-|-|-|-|-|
|name|`string`|`true`| - |navn på ConfigMap|
|mountPath|`string`|`true`| - |mount-path i container|
|data|`object`|`true`| - |data i ConfigMap|
|addHashToName|`boolean`|`false`|false|om hash skal legges til navnet|
...
Oppretter en ExternalSecret og legger til miljøvariabler fra den
...
Opprett en standalone Azure AD Application ressurs
...
Legger til en Azure AD Application ressurs og konfigurerer applikasjonen
