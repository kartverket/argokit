{
  ...
  /**
  Setup for replica sets.
  You can set static replica sets.
  ...
  Variables:
   ...
   - targetCpuUtilization: int (optional) - maximum cpu utilization before increasing current replica sets
   - targetMemoryUtilization: int (optional) - maximum memory utilization before increasing current replica sets
  */
